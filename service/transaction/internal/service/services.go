...
func NewService(deps Deps) *Service {
	...
	return &Service{
		TransactionQuery:           NewTransactionQueryService(deps.Ctx, deps.Repositories.TransactionQuery, deps.Logger, transaction),
		TransactionStatistic:       NewTransactionStatisticService(deps.Ctx, deps.Repositories.TransactionStat, deps.Logger, transaction),
		TransactionStatisticByCard: NewTransactionStatisticByCardService(deps.Ctx, deps.Repositories.TransactionStatByCard, deps.Logger, transaction),
