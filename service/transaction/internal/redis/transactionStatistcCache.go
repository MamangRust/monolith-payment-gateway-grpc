...
func (t *transactionStatisticCache) GetMonthTransactonStatusSuccessCache(req *requests.MonthStatusTransaction) []*response.TransactionResponseMonthStatusSuccess {
...
func (t *transactionStatisticCache) GetYearTransactonStatusSuccessCache(year int) []*response.TransactionResponseYearStatusSuccess {
...
func (t *transactionStatisticCache) GetMonthTransactonStatusFailedCache(req *requests.MonthStatusTransaction) []*response.TransactionResponseMonthStatusFailed {
...
func (t *transactionStatisticCache) GetYearTransactonStatusFailedCache(year int) []*response.TransactionResponseYearStatusFailed {
...
func (t *transactionStatisticCache) GetMonthlyPaymentMethodsCache(year int) []*response.TransactionMonthMethodResponse {
...
func (t *transactionStatisticCache) GetYearlyPaymentMethodsCache(year int) []*response.TransactionYearMethodResponse {
...
func (t *transactionStatisticCache) GetMonthlyAmountsCache(year int) []*response.TransactionMonthAmountResponse {
...
func (t *transactionStatisticCache) GetYearlyAmountsCache(year int) []*response.TransactionYearlyAmountResponse {
