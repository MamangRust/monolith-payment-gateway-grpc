...
func InitConfig() (*Config, error) {
	...
	v.SetDefault("service_name", "role-service")
...
func initRedisServer(ctx context.Context, logger logger.LoggerInterface) (*redis.Client, error) {
	...
	logger.Info("Redis connection established",
		zap.String("addr", fmt.Sprintf("%s:%s", viper.GetString("REDIS_HOST_ROLE"), viper.GetString("REDIS_PORT_ROLE"))),
		zap.Int("db", viper.GetInt("REDIS_DB_ROLE")),
	)
