...
func (w *withdrawStatisticCache) GetCachedMonthWithdrawStatusSuccessCache(req *requests.MonthStatusWithdraw) []*response.WithdrawResponseMonthStatusSuccess {
...
func (w *withdrawStatisticCache) GetCachedYearlyWithdrawStatusSuccessCache(year int) []*response.WithdrawResponseYearStatusSuccess {
...
func (w *withdrawStatisticCache) GetCachedMonthWithdrawStatusFailedCache(req *requests.MonthStatusWithdraw) []*response.WithdrawResponseMonthStatusFailed {
...
func (w *withdrawStatisticCache) GetCachedYearlyWithdrawStatusFailedCache(year int) []*response.WithdrawResponseYearStatusFailed {
...
func (w *withdrawStatisticCache) GetCachedMonthlyWithdraws(year int) []*response.WithdrawMonthlyAmountResponse {
...
func (w *withdrawStatisticCache) GetCachedYearlyWithdraws(year int) []*response.WithdrawYearlyAmountResponse {
